...
<style>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .meth-body h2{font-size:1.7rem;font-weight:600;color:var(--text);margin:2.5rem 0 .6rem;line-height:1.25;border-bottom:1px solid var(--border);padding-bottom:.4rem;max-width:68ch}
  .meth-body h2:first-child{margin-top:.25rem}
  .meth-body h3{font-size:1.3rem;font-weight:600;color:var(--text);margin:1.8rem 0 .4rem;line-height:1.25;max-width:68ch}
